...
If you don't use bower, you can manually download and unpack json-tree ([zip](https://github.com/krispo/json-tree/archive/v0.1.4.zip), [tar.gz](https://github.com/krispo/json-tree/archive/v0.1.4.tar.gz)).
